...
\usepackage{float}
%-----------------------------------------------------
\newcommand{\doctitle}{Human Senses and Perception}
\newcommand{\docsubject}{Illusions}
\newcommand{\docauthor}{Mathias Ramsø Thomsen}
\newcommand{\docdate}{29-11-2015}
\newcommand{\docplace}{AAU-CPH - Medialogy 3rd Semester}
...
\include{PerceptionKnowledge}
\include{TechnologicalAdvancements}
\include{Discussion}
\include{Summary}
\include{Conclusion}
